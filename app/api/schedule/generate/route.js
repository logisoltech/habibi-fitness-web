...
export async function POST(req) {
  try {
    const { userId, weeks = 4 } = await req.json();
    ...
    console.log(`Generating meal schedule for user ${userId} with ${weeks} weeks`);
    ...
    // Import meal scheduler (you'll need to create this or adapt from your server.js)
    // For now, let's create a simple schedule structure
    const schedule = {
      plan: "Weekly Plan",
      weeks: []
    };
